...
| OQ-05 | ~~Are there specific topics that must never be discussed — beyond pricing and internal operations?~~ **Resolved:** The system only responds to topics covered by the knowledge base or the instruction layer. Any out-of-scope topic is redirected without acknowledgement. No enumerated blocklist is maintained. See [CDD §7](../conversation-design-document.md#conversation-design-document-7-prohibited-behaviours). | leadership | Resolved 2026-05-15 |
